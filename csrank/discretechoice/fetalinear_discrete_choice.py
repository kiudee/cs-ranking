...
class FETALinearDiscreteChoiceFunction(FETADiscreteChoiceFunction):
    def __init__(self, n_object_features, n_objects, loss_function=categorical_hinge, learning_rate=1e-3,
