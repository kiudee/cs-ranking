...
class FATELinearDiscreteChoiceFunction(FATEDiscreteChoiceFunction):
    def __init__(self, n_object_features, n_hidden_set_units=2, loss_function=categorical_hinge,
