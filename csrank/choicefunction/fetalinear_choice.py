...
class FETALinearChoiceFunction(FETAChoiceFunction):
    def __init__(self, n_object_features, n_objects, loss_function=binary_crossentropy, learning_rate=1e-3,
    ...
    def set_tunable_parameters(self, learning_rate=1e-3, batch_size=128, reg_strength=1e-4, **point):
